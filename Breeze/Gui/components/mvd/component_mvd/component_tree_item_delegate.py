...
from PySide6.QtCore import QModelIndex, QRect, QTimer, QPoint
from PySide6.QtGui import QPainter, QPen, QFontMetrics, QStandardItemModel, QCursor
from PySide6.QtWidgets import QStyleOptionViewItem, QComboBox, QStyleOptionComboBox, QApplication, QStyle, QWidget, \
    QStyledItemDelegate, QProxyStyle, QSizePolicy

from Api.breeze_app import BreezeApp
from Api.project_documents import Component, Version, Stage
from Api.recipes import Recipe, IngredientSlot, Ingredients
from Api.studio_documents import StageTemplate
from Gui.components.mvd.abstract_mvd import AbstractItemDelegate
from Gui.components.mvd.component_mvd.component_list_model import ComponentItemRoles
from Gui.components.mvd.component_mvd.component_tree_model import ComponentTreeItemRoles, ComponentTreeModel
...
class ComponentTreeItemDelegate(AbstractItemDelegate):
    ...
    def setModelData(self, editor: ComponentBrowser, model: ComponentTreeModel, index: QModelIndex):
        ...
        # TODO:
        #   - add feedback when creating or replacing ingredients
        #   - add extra slot if ingredient_slot is multiple
        #   - version pill
        #   - is_multiple pill
        #   - delete ingredients
